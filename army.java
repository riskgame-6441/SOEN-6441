...
public class army {
	...
	public static void main(String args[]) {
		...
		HashMap<String,Integer> army_per_country = new HashMap<String,Integer>();
		army_per_country = armyPerCountry(p,armies_per_player,country_per_player);
